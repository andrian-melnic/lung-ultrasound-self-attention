...
# ---------------------------------- Layers ---------------------------------- #
        ...
        # Blocks
        self.layer1 = self._make_layer(self.block, 64, num_blocks[0], stride=1)
        self.layer2 = self._make_layer(self.block, 128, num_blocks[1], stride=2)
        self.layer3 = self._make_layer(self.block, 256, num_blocks[2], stride=2)
        self.layer4 = self._make_layer(self.block, 512, num_blocks[3], stride=1, heads=heads, mhsa=True)
